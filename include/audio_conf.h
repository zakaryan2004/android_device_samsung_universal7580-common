...
#define AUX_DIGITAL_SOUND_CARD   SOUND_CARD0
#define BT_SCO_SOUND_CARD        SOUND_CARD0

/* You have to select this number based on your AudioHAL's service */
// Playback Devices
#define PRIMARY_PLAYBACK_DEVICE       5 // primary playback (SOUND_PLAYBACK_DEVICE)
#define LOW_LATENCY_PLAYBACK_DEVICE   5 // Fast Output Profile
#define DEEP_BUFFER_PLAYBACK_DEVICE   1 // deep buffer playback (SOUND_DEEP_BUFFER_DEVICE)
#define COMPR_OFFLOAD_PLAYBACK_DEVICE 0 // offload playback (SOUND_COMPRESS_OFFLOAD_DEVICE)
#define VOICE_CALL_SOUND_DEVICE       2 // voice call capture & playback (SOUND_CAPTURE_VOICE_DEVICE & SOUND_PLAYBACK_VOICE_DEVICE)
#define AUX_DIGITAL_PLAYBACK_DEVICE   0 // HDMI - unsupported
#define BT_SCO_SOUND_DEVICE           3 // bt capture & playback (SOUND_CAPTURE_SCO_DEVICE & SOUND_PLAYBACK_SCO_DEVICE)
#define LOW_LATENCY_CAPTURE_DEVICE    0 // primary capture (SOUND_CAPTURE_DEVICE)
